...
const reviews = [
    {
        ...
        body: 'RexkyGit is a lifesaver! The README generator saved me hours of tedious work. The UI is clean and super intuitive.',
        color: 'bg-pink-300'
    },
    {
        name: 'Bagas P.',
            ...
            <section id="reviews" className="bg-white text-black py-16 lg:py-24 overflow-hidden">
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    <p className="text-lg lg:text-xl text-gray-600 max-w-3xl leading-relaxed text-left">
                        See what developers are saying about their experience with RexkyGit.
                    </p>
                </div>
