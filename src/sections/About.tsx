      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="mb-12 lg:mb-16 text-left">
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-3xl leading-relaxed">
            RexkyGit runs fully client-side, using your GitHub Token and Gemini API Key safely. We prioritize your privacy and simplicity, making Git operations accessible for developers anywhere, anytime.
          </p>
        </div>
